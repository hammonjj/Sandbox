...
public:
    ...
    void setupUi(QDialog *UICSettingsDialog)
    {
        ...
        widget = new QWidget(UICSettingsDialog);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(10, 10, 220, 77));
    ...
    void retranslateUi(QDialog *UICSettingsDialog)
    {
        ...
        directoryEdit->setText(QApplication::translate("UICSettingsDialog", "C:\\Riot Games", 0));
